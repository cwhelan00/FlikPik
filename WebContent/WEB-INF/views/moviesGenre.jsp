...
<head>
	...
	<title>${genreType} Movies - Page ${pageNum}</title>
	...
	<div class="container">
		...
		<div class="row">
			<ul class="pagination col-xs-6">
				<c:if test="${pageNum > 0}">
				<li><a href="<c:url value="/movies/genre/${genreType}/page/${pageNum - 1}" />">&laquo;</a></li>
				<c:if test="${pageNum > 1}">
				<li><a href="<c:url value="/movies/genre/${genreType}/page/${pageNum - 2}" />">${pageNum - 2}</a></li>
				</c:if>
				<li><a href="<c:url value="/movies/genre/${genreType}/page/${pageNum - 1}" />">${pageNum - 1}</a></li>
				</c:if>
				<li class="active"><a href="#">${pageNum}</a></li>
				<li><a href="<c:url value="/movies/genre/${genreType}/page/${pageNum + 1}" />">${pageNum + 1}</a></li>
				<li><a href="<c:url value="/movies/genre/${genreType}/page/${pageNum + 2}" />">${pageNum + 2}</a></li>
				<li><a href="<c:url value="/movies/genre/${genreType}/page/${pageNum + 1}" />">&raquo;</a></li>
			</ul>
		</div>
	</div>
